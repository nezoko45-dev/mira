...
if errorlevel 1 (
  ...
  if errorlevel 1 (
    echo.
    echo Python installation failed. Install Python 3.11, then run this file again.
    pause
    exit /b 1
  )
...
if errorlevel 1 (
  ...
  if errorlevel 1 (
    echo.
    echo Node.js installation failed. Install Node.js LTS, then run this file again.
    pause
    exit /b 1
  )
...
if errorlevel 1 (
  ...
  if errorlevel 1 (
    echo.
    echo FFmpeg installation failed. Install FFmpeg, then run this file again.
    pause
    exit /b 1
  )
)
